...
class UMCTB_Core {
	...
	public function add_admin_assets() {
		...
		wp_enqueue_script( 'um_ctb_admin', um_ctb_lite()->url( 'assets/js/um_ctb.js' ), array( 'jquery' ), UM_Custom_Tab_Builder_Lite::VERSION, true );
		if ( defined( 'um_url' ) ) {
			wp_enqueue_style( 'um_ctb_admin-um-fonts-styles', um_url . 'assets/css/um-fonticons-fa.css', array(), UM_Custom_Tab_Builder_Lite::VERSION );
		}
		wp_enqueue_style( 'um_ctb_admin-styles', um_ctb_lite()->url( 'assets/css/um_ctb-admin.css' ), array(), UM_Custom_Tab_Builder_Lite::VERSION );
	}
}
